...
pipeline {
	...
	environment {
		...
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/atmega4809-cnano-getting-started-with-freertos-studio.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/atmega4809-cnano-getting-started-with-freertos-studio.git'
